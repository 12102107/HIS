...
//验证检验项目名称
	function checkName(){
		...
		$.ajax({
	      type:"post",
	      url:"<%=request.getContextPath()%>/check/checkCheckName.action",
	      data:{
	      	name:name,
	      },
	      async:false,
...
//验证手术名称列表代码
	function checkCode(){
		...
		$.ajax({
	      type:"post",
	      url:"<%=request.getContextPath()%>/check/checkCheckCode.action",
	      data:{
	      	code:code,
	      },
	      async:false,
...
<body class="page-header-fixed">
	<div class="page-container">
		...
		<div class="Bread_crumbs">
			<font class="pull-left">添加检验项目</font> <img
		...
		<div class="responsive-table">
      	...
      	<form name="form" action="${pageContext.request.contextPath}/check/addCheck.action" method="post" id="form">
      	<input type="hidden" name="functionid" value="${functionid }">
			<table class="table table-bordered table-striped header-spcing">
				<tr>
					...
					<th>单位:</th>
					<td bgcolor="#fff" style="vertical-align: middle;"><input type="text" id="unit" name="sci.unit">
					<div id="unitdiv" class="div1"></div>
					</td>
					<th>是否有效:</th>
					<td bgcolor="#fff" style="vertical-align: middle;">
					<select  name="sci.enable" >
			...
			<div style="text-align: center; margin-top: 2%;">
						...
						<button type="button" class="button_blue_74_33"  style="border: medium none;" onclick="javascript:window.location.href = 'checkList.action?functionid=${functionid}'">取消</button>
			</div>	
