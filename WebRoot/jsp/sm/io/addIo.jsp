...
//验证出入量名称
	function checkName(){
		...
		$.ajax({
	      type:"post",
	      url:"<%=request.getContextPath()%>/io/checkIoName.action",
	      data:{
	      	name:name,
	      },
	      async:false,
...
<body class="page-header-fixed">
	<div class="page-container">
		...
		<div class="Bread_crumbs">
			<font class="pull-left">添加出入量信息</font> <img
		...
		<div class="responsive-table">
      	...
      	<form name="form" action="${pageContext.request.contextPath}/io/addIo.action" method="post" id="form">
			...
			<table class="table table-bordered table-striped header-spcing">
				<tr>
					...
					<th>简称:</th>
					<td bgcolor="#fff" style="vertical-align: middle;"><input type="text" id="briefName"
					 name="sio.briefName">
					...
					<select  name="sio.type" >
					<option value="0">出量</option>
					<option value="1">入量</option>
					</select>
					</td>    
				...
				<tr>
					<th>子类型:</th>
					<td bgcolor="#fff" style="vertical-align: middle;"><input type="text" id="subType"
					 name="sio.subType">
					<div id="subTypediv" class="div1"></div>
					</td>
					<th>每最小包装单位中所含有的总剂量:</th>
					<td bgcolor="#fff" style="vertical-align: middle;"><input type="text" id="packageDosageAmount"
					 name="sio.packageDosageAmount">
					<div id="packageDosageAmountdiv" class="div1"></div>
					</td>
					<th>剂量单位:</th>
					<td bgcolor="#fff" style="vertical-align: middle;"><input type="text" id="dosageUnit"
					 name="sio.dosageUnit">
					<div id="dosageUnitdiv" class="div1"></div>
					</td>
					<th>是否有效:</th>
					<td bgcolor="#fff" style="vertical-align: middle;">
					<select  name="sio.enable" >
			...
			<div style="text-align: center; margin-top: 2%;">
						...
						<button type="button" class="button_blue_74_33"  style="border: medium none;" onclick="javascript:window.location.href = 'ioList.action?functionid=${functionid}'">取消</button>
			</div>	
		</form>
</div></div></div>
</body>
