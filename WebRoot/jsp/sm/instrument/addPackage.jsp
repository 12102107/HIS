...
<body class="page-header-fixed">
	<div class="page-container">
		...
		<div class="Bread_crumbs">
			<font class="pull-left">添加手术包</font> <img
		...
		<div class="responsive-table">
      	...
      	<form name="form" action="addInstrumentPackage.action" method="post" id="form">
			...
			<table class="table table-bordered table-striped header-spcing">
				...
				<tr>
					<td>名称:</td>
					<td bgcolor="#fff" style="vertical-align: middle;">
					<input type="text" id="n" name="p.name">
					</td>	
					<td>是否常用:</td>
					<td bgcolor="#fff" style="vertical-align: middle;">
			...
			<table id="i" class="table table-bordered table-striped header-spcing">
				...
				<tr class="instrument">
					...
					<option value="${i.id }">${i.name}--${i.specifications }</option>
					</c:forEach>
					</select>
					</td>	
					<td>数量:</td>
