...
<body class="page-header-fixed">
	<div class="page-container">
		...
		<div class="Bread_crumbs">
			<font class="pull-left">添加手术器械</font> <img
		...
		<div class="responsive-table">
      	...
      	<form name="form" action="addInstrument.action" method="post" id="form">
      		<input type="hidden" name="functionid" value="${functionid }">
			<table class="table table-bordered table-striped header-spcing">
				<tr>
					<td>名称:</td>
					<td bgcolor="#fff" style="vertical-align: middle;">
					<input type="text" id="n" name="i.name">
					</td>
				</tr>
				<tr>	
					<td>规格:</td>
					<td bgcolor="#fff" style="vertical-align: middle;">
					<input type="text" id="s" name="i.specifications">
					</td>
				</tr>
				<tr>	
					<td>单位:</td>
					<td bgcolor="#fff" style="vertical-align: middle;">
					<input type="text" id="u" name="i.unit">
					</td>
				</tr>
				<tr>	
					<td>是否常用:</td>
			...
			<button type="button" class="button_blue_74_33"  style="border: medium none;" onclick="check()">添加</button>
