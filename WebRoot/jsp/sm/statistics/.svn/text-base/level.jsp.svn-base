...
<table class="table table-bordered table-striped header-spcing" ><tr><td style="text-align: left;vertical-align: middle;">	
							<form action="levelStatistics.action" method="post">
						...
						<table class="table table-bordered table-striped header-spcing" id="table">	
							...
							<tr class="No">
								<td>${s.name }</td>
								<td class='lv1'>${s.level1 }</td>
								<td class='lv2'>${s.level2 }</td>
								<td class='lv3'>${s.level3 }</td>
								<td class='lv4'>${s.level4 }</td>
								<td class="total"></td>
							</tr>
							</c:forEach>
							</tbody>
