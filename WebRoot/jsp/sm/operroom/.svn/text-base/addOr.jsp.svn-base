...
//验证手术室列表名称
	function checkName(){
		...
		$.ajax({
	      type:"post",
	      url:"<%=request.getContextPath()%>/sss/checkOrName.action",
	      data:{
	      	name:name,
	      },
	      async:false,
...
<body class="page-header-fixed">
	<div class="page-container">
		...
		<div class="Bread_crumbs">
			<font class="pull-left">添加手术室</font> <img
		...
		<div class="responsive-table">
      	...
      	<form name="form" action="${pageContext.request.contextPath}/sss/addOr.action" method="post" id="form">
			...
			<table  class="table table-bordered table-striped header-spcing">
				<tr>
					...
					<select  name="sor.roomType" >
					<option value="0">手术室</option>
					<option value="1">恢复室</option>
					</select>
					<th>是否有效:</th>
					<td bgcolor="#fff" style="vertical-align: middle;">
					<select  name="sor.enable" >
			...
			<div style="text-align: center; margin-top: 2%;">
						...
						<button type="button" class="button_blue_74_33"  style="border: medium none;" onclick="javascript:window.location.href = 'orList.action?functionid=${functionid}'">取消</button>
			</div>		
