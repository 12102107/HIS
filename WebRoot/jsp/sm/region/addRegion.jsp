...
//验证病区名称
	function checkName(){
		...
		$.ajax({
	      type:"post",
	      url:"<%=request.getContextPath()%>/region/checkRegionName.action",
	      data:{
	      	name:name,
	      },
	      async:false,
...
<body class="page-header-fixed">
	<div class="page-container">
		...
		<div class="Bread_crumbs">
			<font class="pull-left">添加病区</font> <img
		...
		<div class="responsive-table">
      	...
      	<form name="form" action="${pageContext.request.contextPath}/region/addRegion.action" method="post" id="form">
			...
			<div style="text-align: center; margin-top: 2%;">
						...
						<button type="button" class="button_blue_74_33"  style="border: medium none;" onclick="javascript:window.location.href = 'regionList.action?functionid=${functionid}'">取消</button>
			</div>	
