...
//验证科室列表名称
	function checkName(){
		...
		$.ajax({
	      type:"post",
	      url:"<%=request.getContextPath()%>/dept/checkDeptName.action",
	      data:{
	      	name:name,
	      },
	      async:false,
...
<body class="page-header-fixed">
	<div class="page-container">
		...
		<div class="Bread_crumbs">
			<font class="pull-left">添加科室</font> <img
		...
		<div class="responsive-table">
      	...
      	<form name="form" action="${pageContext.request.contextPath}/dept/addDept.action" method="post" id="form">
			...
			<div style="text-align: center; margin-top: 2%;">
						...
						<button type="button" class="button_blue_74_33"  style="border: medium none;" onclick="javascript:window.location.href = 'deptList.action?functionid=${functionid}'">取消</button>
			</div>		
		</form>
</div></div></div>
</body>
